  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <p className="px-4 sm:px-6 lg:px-8 text-base sm:text-lg leading-relaxed mb-6">
        Le <strong>BTS Services Informatiques aux Organisations</strong> (SIO),
        option
      ...
      <div className="flex justify-center mt-8"> 
        <Button
          variant="outline"
          size="lg"
          className="uppercase gap-2 py-6 bg-primary rounded-full border-accent hover:bg-accent text-accent xl:w-[400px] w-80 text-xs xl:text-sm"
        >
