  ...
  return (
    <section className="py-8">
      <div className="container mx-auto px-4">
        <h1 className="text-2xl md:text-3xl font-bold text-center mb-20 text-white ">
          Mes compétences
        </h1>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 ">
          {skills.map((skill, index) => (
            <div
              key={index}
              className="flex flex-col items-center p-4 bg-secondary shadow-md rounded-lg transform transition-all hover:scale-105 hover:shadow-lg hover:border-[1px] hover:border-[#00ff99]"
            >
